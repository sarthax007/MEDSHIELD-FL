...
from medshield.crypto.serialization import deserialize_encrypted_vector, serialize_encrypted_vector
...
def test_ciphertext_serialization(caplog):
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        deserialized = deserialize_encrypted_vector(
            public_context=public_ctx, serialized_vector=serialized
        )
